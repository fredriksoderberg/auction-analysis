auction_item_fields = {
        'object_number': '//form[@id="kvd-bid-bid-form"]/input[4]/@value',
        'auction_URL': '//form[@id="kvd-bid-bid-form"]/input[5]/@value',
        'car_model': '//div[@id="main"]/div/div[3]/div/div[3]/div[1]/div[1]/h1/text()',
        'description' : '//div[@id="main"]/div/div[3]/div/div[3]/div[1]/div[1]/p/text()',
        'place_of_sale' : '//div[@id="main"]/div/div[3]/div/div[3]/div[2]/ul/li[6]/a/text()',
        'estimated_auction_price': '//div[@id="main"]/div/div[3]/div/div[4]/div[1]/ul/li/div/ul[1]/li[2]/div/text()',
        'estimated_dealership_price': '//div[@id="main"]/div/div[3]/div/div[4]/div[1]/ul/li/div/ul[1]/li[4]/div/text()',
        'buyer_fee': '//div[@id="main"]/div/div[3]/div/div[4]/div[1]/ul/li/div/ul[2]/li[2]//text()',
        'auction_start': '//div[@id="main"]/div/div[3]/div/div[3]/div[1]/div[2]/ul[1]/li[2]/p/text()',
